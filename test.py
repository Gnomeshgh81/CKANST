...
parser.add_argument('--encoder_c', type=str, default='./experiments/encoder_c_iter_160000.pth')
parser.add_argument('--encoder_s', type=str, default='./experiments/encoder_s_iter_160000.pth')
parser.add_argument('--Kan_decoder', type=str, default='./experiments/Kan_decoder_iter_160000.pth')
parser.add_argument('--HSI', type=str, default='./experiments/HSI_iter_160000.pth')
